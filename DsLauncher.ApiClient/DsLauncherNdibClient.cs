...
public class DsLauncherNdibApiClient(IOptions<DsLauncherOptions> options)
{
    ...
    public async Task DownloadWholeVersion(string bearerToken, Guid productGuid, Platform platform, Guid packageGuid, Stream stream, EventHandler<float> callback)
    {
